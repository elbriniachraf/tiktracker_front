...
import { FournisseurService } from '../fournisseurs.service';
...
@Component({
  ...
  providers: [FournisseurService], // Service injecté

})
export class GestionFournisseurComponent {
  ...
  public autoCompleteConfig = {
      ...
      if (this.selectedRow) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            this.fournisseurService.deleteFourniusseur(this.selectedRow._id).subscribe({
              next: (response: any) => {
    ...
    loadClients(): void {
      ...
      this.fournisseurService.getFournissseurs(this.currentPage, this.pageSize,this.typeFilter,this.query).subscribe(
